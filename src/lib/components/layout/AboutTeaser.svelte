...
<script lang="ts">
	...
	name: "(Founder Name)", // Replace with actual founder if available
	role: "Founder & CEO",
	image: "/generated/image-a-portrait-of-a-friendly-tech-founder-dr.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"We believe hospitality is the last moat on the internet. Lapel exists to help great companies defend it with software built for care, not just scale."`}
    />
